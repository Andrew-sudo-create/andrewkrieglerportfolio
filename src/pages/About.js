...
function AboutPage() {
    return (
      <div className={styles.about}>
        ...
        <div className={styles.values}>
          ...
          <div className={styles.values__values}>
            <div className={styles.values__value}>
              <img src='https://res.cloudinary.com/du3wd1lbd/image/upload/v1694420184/Andrew%20Kriegler/design_medx1t.svg'/>
            ...
            <div className={styles.values__value}>
            <img src='https://res.cloudinary.com/du3wd1lbd/image/upload/v1694421385/Andrew%20Kriegler/developement_sssaaz.svg'/>
            <div className={styles.values__content}>
            ...
            <div className={styles.values__value}>
              <img src='https://res.cloudinary.com/du3wd1lbd/image/upload/v1694421392/Andrew%20Kriegler/elevation_gs99wi.svg'/>
              <div className={styles.values__content}>
       ...
       <div className={styles.values__values}>
         <p className='text text__mega'>When I was 15, I started learning about making websites. Now I'm 20 and I love it. I like creating things that everyone can see on the internet. I saw that many new businesses don't have good websites, even though they have great things to offer. Every business needs a nice website that works well, and I'm happy I can help with that.</p>
       </div>
     </div>
        <ContactCTA/>
        <Footer/>
