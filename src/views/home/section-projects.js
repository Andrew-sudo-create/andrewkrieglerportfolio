                ...
                <div className={styles.projects__items}>
                    <div className={styles.projects__item}>
                        <div className={styles.projects__image_box}>
                            <img data-aos="fade-left" data-aos-duration="1000" className={styles.projects__img} src="https://res.cloudinary.com/du3wd1lbd/image/upload/v1698305912/Andrew%20Kriegler/black-ink-home_u2dfmt_pslinm.jpg" alt="black ink artists"></img>
                        </div>
                    ...
                    <div className={styles.projects__grid}>
                        <div className={`${styles.projects__item} ${styles.projects__grid__1}}`} >
                            <div className={`${styles.projects__image_box} ${styles.projects__image_box__small}}`}>
                                <img data-aos="fade-right" data-aos-duration="1000" className={styles.projects__img} src="https://res.cloudinary.com/du3wd1lbd/image/upload/v1698305921/Andrew%20Kriegler/tiago-home_havits_ocn2fz.jpg" alt="tiago croucamp"></img>
                            </div>
                            <div className={styles.projects__desc}>
                        ...
                        <div className={`${styles.projects__item} ${styles.projects__grid__2}}`}>
                            <div className={`${styles.projects__image_box} ${styles.projects__image_box__small}}`}>
                                <img data-aos="fade-left" data-aos-duration="1000" className={styles.projects__img} src="https://res.cloudinary.com/du3wd1lbd/image/upload/v1698305916/Andrew%20Kriegler/imaan-home_swboez_iao1hd.jpg" alt="imaans photography"></img>
                            </div>
                            <div className={styles.projects__desc}>
                        ...
                        <div className={`${styles.projects__item} ${styles.projects__grid__3}}`}>
                            <div className={`${styles.projects__image_box} ${styles.projects__image_box__small}}`}>
                                <img data-aos="fade-right" data-aos-duration="1000" className={styles.projects__img} src="https://res.cloudinary.com/du3wd1lbd/image/upload/v1698305914/Andrew%20Kriegler/femsolutions.net__4_dp6wax_zo1cim.png" alt="fems solutions"></img>
                            </div>
                            <div className={styles.projects__desc}>
                        ...
                        <div className={`${styles.projects__item} ${styles.projects__grid__4}}`}>
                            <div className={`${styles.projects__image_box} ${styles.projects__image_box__small}}`}>
                                <img data-aos="fade-left" data-aos-duration="1000" className={styles.projects__img} src="https://res.cloudinary.com/du3wd1lbd/image/upload/v1698305920/Andrew%20Kriegler/tariro-images_a5c5ka_moseoj.jpg" alt="tariro kandawasvika"></img>
                            </div>
                            <div className={styles.projects__desc}>
