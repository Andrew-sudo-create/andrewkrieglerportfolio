      ...
      <div>
        <div className={styles.values}>
            ...
            <div className={styles.values__value}>
                <img alt='1' data-aos="fade-right" data-aos-duration="1000" className={styles.values__number} src="https://res.cloudinary.com/du3wd1lbd/image/upload/v1694588270/Andrew%20Kriegler/1_azvrzl.svg" />
            ...
            <div className={styles.values__value}>
                <img alt='2' data-aos="fade-right" data-aos-duration="1000" className={styles.values__number} src="https://res.cloudinary.com/du3wd1lbd/image/upload/v1694588270/Andrew%20Kriegler/2_dscodr.svg"/>
                <div data-aos="fade-left" data-aos-duration="1000" className={styles.values__content}>
            ...
            <div className={styles.values__value}>
                <img alt='3' data-aos="fade-right" data-aos-duration="1000" className={styles.values__number} src="https://res.cloudinary.com/du3wd1lbd/image/upload/v1694588270/Andrew%20Kriegler/3_bjpo8b.svg"/>
                <div data-aos="fade-left" data-aos-duration="1000" className={styles.values__content}>
